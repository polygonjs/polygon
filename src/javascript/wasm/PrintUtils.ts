...
export const writeToConsoleLog = writeToConsoleLogBasic; //writeToConsoleLogWithBuffer;

function writeToConsoleLogBasic(str: string, to_standard_error: boolean) {
	if (to_standard_error == true) {
		console.error(str);
	} else {
		console.log(str);
	}
...
// function writeToConsoleLogWithBuffer(str: string, to_standard_error: boolean) {
// 	if (
// 		console_buffer &&
